...
#discretize the spaces --> tabular case
...
if __name__ == '__main__':
    ...
    for i in range(numGames):
        ...
        while not done:
            ...
            Q[state,action] = Q[state,action] + ALPHA*(reward + GAMMA*Q[state_,action_] - Q[state,action])  # state_ is generated by action (epislon greedy); action_ is maxAction (Q,state_)
    ...
    for i in range(numGames):
        ...
        while not done:
            ...
            epRewards += reward
            Q[state,action] = Q[state,action] + ALPHA*(reward + GAMMA*Q[state_,action_] - Q[state,action]) # state_ generated by epsilon greedy; action_ generated by epsilon greedy
